...
initApp({
  supabaseUrl: import.meta.env.VITE_SUPABASE_URL || window.__APP_CONFIG__?.supabaseUrl || "",
  supabaseKey: import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY || window.__APP_CONFIG__?.supabaseKey || "",
